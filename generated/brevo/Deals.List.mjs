export async function compute(params, ctx) {
  ...
  addQueryParam("filters[attributes.deal_name]", params["filters[attributesDealName]"]);
  addQueryParam("filters[linkedCompaniesIds]", params["filters[linkedCompaniesIds]"]);
  addQueryParam("filters[linkedContactsIds]", params["filters[linkedContactsIds]"]);
