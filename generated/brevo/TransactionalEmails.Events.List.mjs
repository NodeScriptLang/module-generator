export async function compute(params, ctx) {
  ...
  addQueryParam("days", params["days"]);
  addQueryParam("email", params["email"]);
  addQueryParam("event", params["event"]);
  addQueryParam("tags", params["tags"]);
  addQueryParam("messageId", params["messageId"]);
  addQueryParam("templateId", params["templateId"]);
