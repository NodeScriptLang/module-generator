export async function compute(params, ctx) {
  let url = new URL(
    "https://generativelanguage.googleapis.com/v1beta/models/{model}:generateAnswer"
  ...
  let body = {};
  body["answerStyle"] = params["answerStyle"];
  body["contents"] = params["contents"];
  body["inlinePassages"] = params["inlinePassages"];
  body["safetySettings"] = params["safetySettings"];
  body["semanticRetriever"] = params["semanticRetriever"];
