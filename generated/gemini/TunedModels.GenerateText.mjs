export async function compute(params, ctx) {
  let url = new URL(
    "https://generativelanguage.googleapis.com/v1beta/tunedModels/{model}:generateText"
  ...
  let body = {};
  body["candidateCount"] = params["candidateCount"];
  body["maxOutputTokens"] = params["maxOutputTokens"];
