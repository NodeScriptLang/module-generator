export async function compute(params, ctx) {
  ...
  addQueryParam("InvoiceNumbers", params["invoiceNumbers"].join(","));
  addQueryParam("ContactIDs", params["contactIds"].join(","));
  addQueryParam("Statuses", params["statuses"].join(","));
  addQueryParam("page", params["page"]);
  addQueryParam("includeArchived", params["includeArchived"]);
  addQueryParam("createdByMyApp", params["createdByMyApp"]);
  addQueryParam("unitdp", params["unitdp"]);
  addQueryParam("summaryOnly", params["summaryOnly"]);
  addQueryParam("pageSize", params["pageSize"]);
  addQueryParam("searchTerm", params["searchTerm"]);
