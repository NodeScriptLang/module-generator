export async function compute(params, ctx) {
  ...
  addQueryParam("categoryId", params["categoryId"]);
  addQueryParam("forUsername", params["forUsername"]);
  addQueryParam("hl", params["hl"]);
  for (const item of params["id"] ?? []) {
    addQueryParam("id", item);
  }
  addQueryParam("managedByMe", params["managedByMe"]);
  addQueryParam("maxResults", params["maxResults"]);
  addQueryParam("mine", params["mine"]);
  addQueryParam("mySubscribers", params["mySubscribers"]);
